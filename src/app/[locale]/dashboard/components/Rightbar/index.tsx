...
const RightbarContent = () => (
  <div className="flex-1 overflow-y-auto hide-scrollbar h-[calc(100vh-64px)]">
                ...
                >
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <h4 className="font-semibold text-sm">Bildirim Detayı</h4>
                    </div>
                    <div className="space-y-2">
                ...
                >
                  <div className="space-y-2">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-sm">İşlem Detayı</h4>
    ...
    {/* Hekimler Container */}
    <div className="px-4 py-1">
      <h3 className="text-base font-semibold mb-3 text-foreground">Hekimler</h3>
      <ul className="space-y-1">
        {doctors.map((d, i) => (
          <li key={i}>
            <Popover>
              ...
              >
                <div className="space-y-2">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-sm">Hekim Bilgileri</h4>
                      <p className="text-xs text-muted-foreground">
                        Veteriner hekimi
                      </p>
                    </div>
    ...
    <>
      ...
      {isVisible && (
        <>
          ...
          />
          {/* Mobil Rightbar */}
          <aside className="fixed right-0 top-0 h-full w-64 bg-background border-l border-border z-50 lg:hidden shadow-lg transform transition-transform duration-300 ease-in-out">
