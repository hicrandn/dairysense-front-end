          ...
          <ul className="space-y-1 ">
            {notifications.map((n, i) => (
              <li key={i}>
                <Link
                  href="#"
                  className="flex items-center gap-3 px-2 py-3 rounded-lg transition-colors text-sm hover:bg-gray-50 w-full"
                >
                  <Image
                    src={n.icon}
                    alt="icon"
          ...
          <ul className="space-y-1">
            {doctors.map((d, i) => (
              <li key={i}>
                <Link
                  href="#"
                  className="flex items-center gap-3 px-2 py-3 rounded-lg transition-colors text-base hover:bg-gray-50 w-full"
                >
